    ...
    <header class="absolute inset-x-0 top-0 z-50">
      <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <RouterLink class="text-sm font-semibold leading-6 text-gray-900" to="/login">Log in <span
    ...
    <main class="isolate">
          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mt-16 flow-root sm:mt-24">
              <div
                ...
                <img alt="App screenshot" class="rounded-md shadow-2xl ring-1 ring-gray-900/10"
                     height="1442" src="https://tailwindui.com/img/component-images/project-app-screenshot.png"
                     width="2432"/>
              </div>
            </div>
          </div>
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div
          ...
          <img alt="Transistor"
               class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" height="48"
          ...
          <img alt="Tuple"
               ...
               width="158"/>
          <img alt="SavvyCal"
               class="col-span-2 max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1" height="48"
               src="https://tailwindui.com/img/logos/158x48/savvycal-logo-gray-900.svg"
               width="158"/>
          <img alt="Statamic"
               class="col-span-2 col-start-2 max-h-12 w-full object-contain sm:col-start-auto lg:col-span-1" height="48"
        ...
        <div class="mt-16 flex justify-center">
          <p class="relative rounded-full px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/10 hover:ring-gray-900/20">
            <span
                class="hidden md:inline">Transistor saves up to $40,000 per year, per employee by working with us.</span>
            <a class="font-semibold text-indigo-600" href="#"><span aria-hidden="true" class="absolute inset-0"/> Read
            ...
            <div v-for="feature in features" :key="feature.name" class="relative pl-16">
              <dt class="text-base font-semibold leading-7 text-gray-900">
                <div class="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
                  <component :is="feature.icon" aria-hidden="true" class="h-6 w-6 text-white"/>
                </div>
                {{ feature.name }}
              </dt>
      ...
      <div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
        <div
          ...
          <div class="relative mx-auto max-w-2xl lg:mx-0">
            <img alt="" class="h-12 w-auto" src="https://tailwindui.com/img/logos/workcation-logo-white.svg"/>
            <figure>
              <blockquote class="mt-6 text-lg font-semibold text-white sm:text-xl sm:leading-8">
                <p>“Amet amet eget scelerisque tellus sit neque faucibus non eleifend. Integer eu praesent at a. Ornare
                  ...
                  ultricies habitant malesuada lorem ac.”</p>
              </blockquote>
              ...
              <div>
                ...
                <ul class="mt-8 space-y-3 text-sm leading-6 text-gray-600" role="list">
                  <li v-for="feature in tier.features" :key="feature" class="flex gap-x-3">
                    <CheckIcon aria-hidden="true" class="h-6 w-5 flex-none text-indigo-600"/>
                    {{ feature }}
                  </li>
                </ul>
              </div>
              <a :aria-describedby="tier.id"
