    ...
    <div class="mt-8 flow-root overflow-hidden">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <table class="w-full text-left">
          ...
          <tr>
            <th class="relative isolate py-3.5 pr-3 text-left text-sm font-semibold text-gray-900" scope="col">
              Name
            ...
            <th class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell" scope="col">
              Title
            </th>
            <th class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 md:table-cell" scope="col">
              Email
            </th>
